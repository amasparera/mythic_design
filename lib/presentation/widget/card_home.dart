...
class CardHome extends StatelessWidget {
  const CardHome({
    Key? key,this.onTap, required this.product, required this.statusFavorite
  }) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                GestureDetector(child:  Icon(Icons.favorite,color:statusFavorite? Colors.red: Colors.grey,))
              ],
            ),
             BuyCurrent(price: product.productPrice,)
          ],
        ),
      ),
    );
